...
void loop() {
    ...
    unsigned short target_s_pw = (msg_buffer.msg.pw_servo <= S_PW_MAX && msg_buffer.msg.pw_servo >= S_PW_MIN)
                                     ? msg_buffer.msg.pw_servo
                                     : steering_pw;
    ...
    unsigned short target_m_pw =
        (msg_buffer.msg.pw_esc <= M_PW_MAX && msg_buffer.msg.pw_esc >= M_PW_MIN) ? msg_buffer.msg.pw_esc : motor_pw;
